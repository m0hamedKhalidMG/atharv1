  ...
  const locationsData = {
    الرياض: {
      images: [
        ...
        require('../images/الرياض/3.jpeg'),
      ],
      description:
        'الرياض هي عاصمة المملكة العربية السعودية، تقع الرياض وسط شبه الجزيرة العربية في هضبة نجد وتضم 58 موقعاً ومعلماً أثرياً .',
      places: [
        'قرية الفاو',
        'موقع المقر',
        'مسجد اليمامة الأثري',
    ...
    'المدينة المنورة': {
      ...
      description:
        'المَدِينَة المُنَورَة هي أول عاصمة في تاريخ الإسلام وثاني أقدس الأماكن للمسلمين بعد مكة. تقع في الحجاز التاريخية غرب المملكة العربية ، وتضم 47 موقعا .',
      places: [
       'المسجد النبوي',
       'مسجد قباء',
        'جبل اللؤلؤة',
  ...
  جدة: {
   ...
   " مكة المكرمة": {
      images: [
        ...
        require('../images/مكة المكرمة/3(1).jpeg'),
      ],
      description:
